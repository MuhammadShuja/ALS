...
public class CategoryGridWithIconsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<Category> items;
    private OnItemClickListener listener;

    public CategoryGridWithIconsAdapter(Context mContext, List<Category> items, OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View dataLayoutView = LayoutInflater.from(mContext).inflate(
                R.layout.card_category_grid_with_icon, parent, false);
